                ...
                <div className="section-padding-4rem pt0 inner_padding border_blue">
                  ...
                  >
                    <div className="slide-header inner-flex inner-flex-common">
                      ...
                      <div className="slide-counter flex-row inner-flex-small">
                        ...
                        <div className="flex-row ale">
                          <p className="font_32 fw_400 black-color">
                            {String(currentIndex1 + 1).padStart(2, "0")} /
                          </p>
                      ...
                      <p className="slide-content">{slides[currentIndex1]}</p>
                    </div>
                    <div className="slide-controls">
                      <div className="nav-buttons">
                        ...
                        <button
                          onClick={goNext}
                          className={`nav-btn ${
                            currentIndex1 == slides.length - 1 ? "disable" : ""
                          }`}
                        >
                          <span className="material-symbols-outlined">
                            chevron_right
                  ...
                  >
                    <div className="slide-header inner-flex inner-flex-common">
                      ...
                      <div className="slide-counter flex-row inner-flex-small">
                        ...
                        <div className="flex-row ale">
                          <p className="font_32 fw_400 black-color">
                            {String(currentIndex2 + 1).padStart(2, "0")} /
                          </p>
                          <p className="font_24 gray-color fw_400">
                      ...
                      <p className="slide-content">{slides2[currentIndex2]}</p>
                    </div>
                    <div className="slide-controls">
                      <div className="nav-buttons">
                        <button
                        ...
                        <button
                          onClick={goNext2}
                          className={`nav-btn ${
                            currentIndex2 == slides2.length - 1 ? "disable" : ""
                          }`}
                        >
                          <span className="material-symbols-outlined">
                            chevron_right
                  ...
                  >
                    <div className="slide-header inner-flex inner-flex-common">
                      ...
                      <div className="slide-counter flex-row inner-flex-small">
                        ...
                        <div className="flex-row ale">
                          <p className="font_32 fw_400 black-color">
                            {String(currentIndex3 + 1).padStart(2, "0")} /
                          </p>
                          <p className="font_24 gray-color fw_400">
                            {String(slides3.length).padStart(2, "0")}
                          </p>
                        </div>
                      </div>
                      <p className="slide-content">{slides3[currentIndex3]}</p>
                    </div>
                    <div className="slide-controls">
                      <div className="nav-buttons">
                        <button
                        ...
                        <button
                          onClick={goNext3}
                          className={`nav-btn ${
                            currentIndex3 == slides3.length - 1 ? "disable" : ""
                          }`}
                        >
                          <span className="material-symbols-outlined">
                            chevron_right

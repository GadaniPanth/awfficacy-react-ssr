    ...
    const tabData = [
        ...
        },
        {
            ...
            tab_counter: [
                {
                    number: "102.5",
                    text: "Million tonnes (FY21) - Total Crude Steel Production",
                },
                {
                    number: "94.7",
                    text: "million tonnes (FY21) - Consumption of Finished Steel",
                },
                {
                    number: "77.2",
                    text: "Kgs (FY22) - Per Capita Consumption of Steel",
                },
        ...
        },
        {
            ...
            tab_counter: [
                ...
                {
                    number: "900",
                    text: "cr INR (FY24)-Projected Annual Sales Turnover",
                },
            ],
            // expert_img: "assets/images/home/expert.png",
            expert_title: "Sector Expert",
                                ...
                                <div className="innner-flex">
                                    <div className="inner-flex inner-flex-medium">
                                        ...
                                        <div className="btn-2">
                                            ...
                                            >
                                                <div className="know_more-button">
                                                    Know More
                                                    {/* <div className="arrow-svg">
                                                        <img src="images/what_we_do/blueArrow.svg" alt="" />
                                                    </div> */}
                                                    <div className="arrow-svg"><svg width="18" height="19" viewBox="0 0 18 19" fill="none" xmlns="http://www.w3.org/2000/svg"><g clip-path="url(#clip0_115_36)"><path d="M0.317005 8.02907L17.2622 0.665957C17.3593 0.623773 17.4669 0.61178 17.5708 0.631536C17.6748 0.651293 17.7705 0.701886 17.8453 0.776734C17.9202 0.851581 17.9707 0.94722 17.9905 1.05121C18.0102 1.1552 17.9982 1.26272 17.9561 1.3598L10.5929 18.3051C10.55 18.404 10.4777 18.4873 10.3859 18.5439C10.2941 18.6004 10.1872 18.6275 10.0795 18.6214C9.97183 18.6153 9.86863 18.5763 9.78379 18.5098C9.69896 18.4432 9.63656 18.3523 9.60502 18.2491L8.02609 13.0866C7.84686 12.4991 7.52597 11.9647 7.09167 11.5304C6.65736 11.0961 6.12295 10.7752 5.53548 10.596L0.372938 9.01703C0.269812 8.98549 0.178833 8.9231 0.112265 8.83826C0.0456963 8.75342 0.00673676 8.65021 0.000642776 8.54254C-0.00545311 8.43487 0.0216064 8.32793 0.0781746 8.23611C0.134741 8.1443 0.218098 8.07204 0.317005 8.02907Z" fill="currentColor"></path></g><defs><clipPath id="clip0_115_36"><rect width="18" height="18" fill="white" transform="matrix(-1 0 0 1 18 0.622223)"></rect></clipPath></defs></svg></div>
                                                </div>
                                            </a>
                                        </div>
                                    </div>
                                            ...
                                            <div className="pharma-vector-images1">
                                                <div className="relative">
                                                    <div className="pharma-vector-img1">
                                                        <div
                                                            className="circle-vector-img relative"
                                                            id="box"
                                                            style={{
                                                        ...
                                                        <div className="buttons_postition">
                                                            <div className="button_tabs">
                                                                ...
                                                                >
                                                                    <img
                                                                        src="images/what_we_do/blue-up-arrow.svg"
                                                                        alt=""
                                                                    />
                                                                </button>
                                                                <button
                                                                ...
                                                                >
                                                                    <img
                                                                        src="images/what_we_do/blue-down-arrow.svg"
                                                                        alt=""
                                                                    />
                                                                </button>
                                                            </div>
                                    ...
                                    <div className="flex-row alc j-c-sb flex-colum">
                                        <div className="section-7-paragraph inner-flex inner-flex-medium">
                                            <p className="font_24 fw_400 black-color">
                                                ...
                                                18% to India's industrial output, and 31% to India's
                                                total exports (FY 2023-24), the state offers a robust
                                                businessenvironment complemented by world-class
                                                infrastructure, industry-friendly policies, and a
                                                skilled workforce. With a per capita income 1.7 times
                                                higher than the national average, Gujarat has
                                                consistently led in industrial excellence, logistics
